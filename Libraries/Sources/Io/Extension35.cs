...
namespace Cube.Mixin.IO.Backports
{
    /* --------------------------------------------------------------------- */
    ///
    /// Extension
    ///
    /// <summary>
    /// Provides extended methods of the IO class. This class is only
    /// provided for .NET Framework 3.5 for backward compatibility.
    /// </summary>
    ///
    /* --------------------------------------------------------------------- */
